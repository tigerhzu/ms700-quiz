...
(function () {
  ...
  function render() {
    ...
    progressEl.textContent = `${view.length} question${view.length === 1 ? "" : "s"} · answers are shuffled each attempt`;
  ...
  function grade() {
    ...
    resultEl.innerHTML =
      ...
      `<div>Review the explanations below, then hit “Shuffle &amp; retry”.</div>`;
